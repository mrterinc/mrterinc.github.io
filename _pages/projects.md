...
description: 
---
<strong>_Publications_</strong>

**Auditors and Client Investment Efficiency: A Quasi‑replication and Further Insights from a Regulatory Change** _with Christopher Bleibtreu, Luciana Orozco and Zhenyang Shi_
...
<strong>_Working Papers_</strong>

**Auditor-Client Compatibility and Audit Quality** _with Tzachi Zach (under revision for 3rd round at Contemporary Accounting Research)_
...
**When the Spotlight Burns: Spillover Effects of Negative Media Coverage on Audit Quality** _with Stavriana Hadjigavriel_
